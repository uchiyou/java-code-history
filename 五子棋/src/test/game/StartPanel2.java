...
*/
public class StartPanel2 extends javax.swing.JFrame {
	...
	*/
	public static void main(String[] args) {
		SwingUtilities.invokeLater(new Runnable() {
			public void run() {
				StartPanel2 inst = new StartPanel2();
	...
	private void initGUI() {
		try {
			...
			{
				final int FIRST_DOT=0;
				final int SPAN=50;
				final int COWS=10;
				final int COLS=10;
				final int CHESS_COUNT=100;
				Point [] chesslist=new Point[(COWS+1)*(1+COLS)];
				...
				public  void paint(Graphics g){
					...
					int xpos=FIRST_DOT+4*SPAN;
					int ypos=FIRST_DOT+6*SPAN;
					g.setColor(Color.blue);
					g.fillOval(xpos-SPAN/2, ypos-SPAN/2, SPAN, SPAN);
